...
public class C01_TestNotasyonu {
  /*
  Bu class içerisinde 3 test calistiralim
  1- google anasayfaya gidip, url'nin google icerdigini test edin
  2-wisequarter anasayfaya gidip url'nin wisequarter icerdigini test edin
  3- amazon anasayfaya gidip, amazon logosunun gorundugunu test edin
   */
    /*
    JUnit'in bize sagladigi ilk ve belki de en onemli ozellik test method'larinin bagimsiz
    olarak calistirilabilmesini saglayan @Test notasyonudur

    JUnit ile class level'dan birden fazla test method'u calistirirsak hangi siralama ile
    calistiracagini ongoremeyiz ve yonetemeyiz.

    Diyelim ki bir test method'u uzerinde calisiyorsunuz ve o method'un toplu
    calistirilmalarda kullanilmasini istemiyorsunuz.Bu durumda @Ignore kullanabiliriz.
     */
  WebDriver driver;
    @Test @Ignore
