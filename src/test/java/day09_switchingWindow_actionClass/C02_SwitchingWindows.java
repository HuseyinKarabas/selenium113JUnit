...
public class C02_SwitchingWindows extends TestBase {
    ...
    ANCAKKKKK......
    biz newWindow() method'unu kullanmadan bir link tikladigimizda yeni window aciliyorsa driver
    eski window'da kalir. Yeni window'a driver'i gecirebilmek icin yeni window'un WindowHandleDegerine
    ihtiyacimiz vardir.
     */
    @Test
