...
public class C02_WebTables extends TestBase {
   ...
   //  6. Tablodaki satir sayisini yazdirin
        List<WebElement> satirlarList=driver.findElements(By.xpath("(//div[@role='row'])/div[3]"));
   ...
   //  8. Tablodaki 3.kolonu yazdirin
        List<WebElement> ucuncuSutunElementleri=driver.findElements(By.xpath("//div[@role='gridcell']"));
